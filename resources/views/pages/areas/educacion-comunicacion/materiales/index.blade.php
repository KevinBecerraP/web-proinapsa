...
@section('title', 'Materiales de Educación y Comunicación')
        ...
        <div class="rs-breadcrumbs breadcrumbs-overlay">
            ...
            <div class="breadcrumbs-text" style="color: {{ $banner?->title_color ?? '#ffffff' }}">
                ...
                <ul style="color: {{ $banner?->title_color ?? '#ffffff' }}">
                    ...
                    <li style="color: {{ $banner?->title_color ?? '#ffffff' }}">Materiales de Educación y Comunicación</li>
                </ul>
            </div>
        </div>
        <!-- Breadcrumbs End -->
        ...
        <div class="rs-about style9 pt-100 pb-20 md-pt-70 md-pb-70">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    @endif
                    <div class="content">
                        <div class="sub-title mb-20">Materiales Educativos</div>
    ...
    <script>
        document.querySelectorAll('#materialFilter button').forEach(function(btn) {
            btn.addEventListener('click', function() {
                document.querySelectorAll('#materialFilter button').forEach(b => b.classList.remove(
                    'active'));
